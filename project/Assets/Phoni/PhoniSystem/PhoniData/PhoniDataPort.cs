...
namespace Phoni {
	...
	#region Phoni Data Region
		...
		//[PhoniData(PhoniDataCode.DATA_CUSTOM_STATE, sendingCase = SendingCase.SendToBoth)]
		[PhoniData(PhoniDataCode.DATA_CUSTOM_STATE)]
		public PhoniDataWrapper<string> CustomState {get; private set;}
		
		/*
		[PhoniData(PhoniDataCode.DATA_CUSTOM_STATE)]
		public PhoniDataWrapperCustom<PhoniCustomDataSample> CustomState {get; private set;}
		*/
